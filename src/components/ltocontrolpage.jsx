...
export default function LTOControlPage() {
  const ups = {
    soc: 75,
    status: "IDLE",
    current: 0,
  ...
  const cardStyle = {
    ...
    minWidth: 0, // critical for flex/grid children
  };
  ...
  const labelStyle = {
    width: "180px", // fixed min width for labels
    background: "#f2f2f2",
    padding: "12px",
    fontWeight: 600,
    color: "#666",
  ...
  return (
    ...
    >
      ...
      <div className="row g-4 align-items-stretch">
        {/* LEFT CARD */}
        <div className="col-md-7 d-flex min-w-0">
          <div style={{ width: "100%" }}>
            <h5
            ...
            <div style={cardStyle}>
              ...
              <div className="d-flex align-items-center mb-3 justify-content-between">
                <div className="fw-bold" style={{ color: "#006666" }}>
                  SoC (%)
                </div>
              ...
              <div
                ...
                style={{
                  ...
                  rowGap: "8px",
                  columnGap: "12px",
                  gridTemplateColumns: "minmax(180px, 40%) 1fr",
                }}
              >
        ...
        {/* RIGHT CARD */}
        <div className="col-md-5 d-flex min-w-0">
          <div style={{ width: "100%" }}>
            <h5
              className="text-center mb-4"
              style={{ color: "#8B0000", fontWeight: 700 }}
